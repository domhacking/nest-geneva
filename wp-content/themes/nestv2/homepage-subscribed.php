...
<div class="homeIntro"><?php the_field('intro_text'); ?></div>
 ...
 <?php $post = $tmp_post; ?>
		...
		Receive all the latest news & info regarding NEST - exhibitions, latest apartments, promotions, parties - straight in your mailbox by subscribing to our newsletter.<br /><br />
        <div id="sub-confirm">Welcome to our mailing list and thank you for joining, your subscription was a success!</div>
		</div>
...
<div id="buttons"><input type="submit" value="" /></div>
		...
		<div class="joinUs"><a href="https://www.facebook.com/NESTGalleriesGeneva" target="blank"><img src="<?php the_field('facebook_icon'); ?>"></a></div>
		</div>
        </div>
