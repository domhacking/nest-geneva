...
.nest-gallery #bg_containers .bg3 {background:url(images/purple-dots.png) no-repeat;background-position:left 390px !important;}
		...
		<div id="artistInfo">
			...
			<?php
				...
				if(get_field('artists_names')) {
					...
					while(the_repeater_field('artists_names')) { ?>
						...
						<div class="artistName"><a href="http://www.nest-geneva.ch/?artists=<?php echo $artistVar; ?>"><?php the_sub_field('artist_name'); ?></a></div>
			...
			<div class="theDates"><?php echo $newStartDate; ?> - <?php echo $newEndDate; ?></div>
