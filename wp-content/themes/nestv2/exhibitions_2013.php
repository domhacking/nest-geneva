<?php
/*
Template Name: Exhibitions Past 2013
*/
?>
...
.theYears li.all a:hover{
		...
		<div class="gall_top_left">
			...
			<?php
				...
				if($today > $end && $end_year == '13' && $wGallery == 'gallery'){
		...
		<div class="gall_top_left">
			...
			<?php
				...
				if($today > $end && $end_year == '13' && $wGallery == 'pop-up'){
		...
		<div class="gall_top_right">
			...
			<?php
				...
				if($today > $end && $end_year == '13' && $wGallery == 'yard'){
