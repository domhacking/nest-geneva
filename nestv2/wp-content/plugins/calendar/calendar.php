  ...
  if ($show_cat == 'true')
    {
      ...
      $catname = ($cat_details->category_name);
...
<span class="event-title-break"></span><br />';
  ...
  $details = '<span class="calnk here"><a href="'.$linky.'" '.$style.' class="'.$catname.'">' . stripslashes($event->event_title) . '<span '.$style.'>' . $header_details . '' . stripslashes($event->event_desc) . '</span></a></span>';
