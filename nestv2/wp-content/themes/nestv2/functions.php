...
register_sidebar(array(
	...
	register_sidebar(array(
		...
		register_sidebar(array(
		'name'=> 'Sub Menu Living Children',
		'id' => 'sub_menu_living_children',
		'before_widget' => '<li id="%1$s" class="widget %2$s">',
		'after_widget' => '</li>',
		'before_title' => '',
		'after_title' => '',
		...
		register_sidebar(array(
		'name'=> 'Sub Menu Gallery Children',
		'id' => 'sub_menu_gallery_children',
		'before_widget' => '<li id="%1$s" class="widget %2$s">',
		'after_widget' => '</li>',
		'before_title' => '',
		'after_title' => '',
...
add_image_size( 'tl_gallery_thumb', 420, 300, true );
add_image_size( 'artist_list_thumb', 200, 200, true );
add_image_size( 'artist_page_img', 630, 999, false );
add_image_size( 'news_img_sml', 160, 100, false );
add_image_size( 'news_img_lrg', 670, 999, false );

// Add custom page type artist
add_action('init','create_my_post_artist');

function create_my_post_artist() {
...
// Add custom page type exhibition
add_action('init','create_my_post_exhibition');

function create_my_post_exhibition() {
...
// Add custom page type Entry
add_action('init','create_my_post_entry');

function create_my_post_entry() {
	register_post_type('nest_entries',
		array(
			'labels' => array(
				'name'=>__('Entries'),
