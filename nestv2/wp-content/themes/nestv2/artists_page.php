...
<?php endif; ?></div>
		...
		<li>
			...
			<?php
				$args = array( 'post_type' => 'artists', 'orderby' => 'meta_value', 'meta_key' => 'alpha_listing', 'order' => 'asc', 'posts_per_page' => -1 );
			...
			<h4 class="<?php echo $artistclass; ?>"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h4>
